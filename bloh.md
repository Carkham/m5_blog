...
## Summary
In this blogpost, we have shown two inference features: inference with M5 Forecasting data and Airpassengers data, and a training feature: build and train DeepAR model with M5 Forecasting data. The source code have been given above. With these features in DJL, now users can start mining the timeseriese data conveniently in Java.
